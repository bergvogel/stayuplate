<!--
  To run this demo locally, start a server in the root of this repository. If you have python installed, you can simply run 'python -m SimpleHTTPServer' after you 'cd' into the repo.
  -->
<!doctype html>
<html>
  <head>
    ...
    <link href="smooth/normalize.css" rel="stylesheet" type="text/css" />
    <link href="smooth/keyframes.css" rel="stylesheet" type="text/css" />
    <link href="smooth/layout.css" rel="stylesheet" type="text/css" />
    <link href="smooth/pageTransitions.css" rel="stylesheet" type="text/css" />
  </head>
  <body>
    ...
    <script src="/src/jquery.smoothState.js"></script>
